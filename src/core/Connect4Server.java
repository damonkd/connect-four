    ...
    try {
      ...
      while (true) {
        ...
        if (connect.winner(1)) {
          ...
          sendMove(toPlayer2, connect.columnHeight(column), column);
          break;
        }
        else {
        ...
        cell[row][column] = 2;
        row = connect.moveGUI(column,2);
        connect.printGame();
        sendMove(toPlayer2, row, column);
        System.out.println(connect.columnHeight(column));
        ...
        if (connect.winner(2)) {
          ...
          sendMove(toPlayer1, connect.columnHeight(column), column);
        }
      }
    }
    catch(IOException ex) {
